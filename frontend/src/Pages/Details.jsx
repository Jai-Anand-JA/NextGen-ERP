        ...
        <div className="flex flex-col items-center mb-8 space-y-4">
          <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-blue-500">
            {photo ? (
              ...
              <div className="w-full h-full flex items-center justify-center text-gray-400 bg-base-200">
                No Photo
              </div>
            )}
          </div>
          <label className="cursor-pointer bg-primary/10 text-primary px-4 py-2 rounded hover:bg-primary/20 transition">
            Upload Photo
            <input
              type="file"
              accept="image/*"
